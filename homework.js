...
// Array, take odd numbers, only eevnt numbers 

let numbers = [4, 37, 18, 29, 52, 103, 22]
let odd = numbers.reduce(function(even, odd)) {
  return odd/even
},0)
...
// function, calleded shortWOrds, has array returns new array with words that are 3 letters long or less 

let shortWords = ["basin", "pit", "cheese", "bun", "river"]
let filterWords = shortWords.filter(function(shortWords)) {
  return shortWords.length <= 3
})
